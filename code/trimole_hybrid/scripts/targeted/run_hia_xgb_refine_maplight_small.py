...
for combo in itertools.product(*vals):
    ...
    for seed in SEEDS:
        ...
        pd.DataFrame(rows).to_csv(OUT_DIR / "hia_xgb_refine_maplight_small_live.csv", index=False)

df = pd.DataFrame(rows)
df.to_csv(OUT_DIR / "hia_xgb_refine_maplight_small_summary.csv", index=False)
...
agg.to_csv(OUT_DIR / "hia_xgb_refine_maplight_small_agg.csv", index=False)

print("\n=== HIA MAPLIGHT-XGB SMALL AGG ===")
print(agg.to_string(index=False))
print("\nSaved:")
print(" -", OUT_DIR / "hia_xgb_refine_maplight_small_summary.csv")
print(" -", OUT_DIR / "hia_xgb_refine_maplight_small_agg.csv")
