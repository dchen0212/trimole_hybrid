...
SEED_GROUPS = {
    "family_gated_5seed": (
        ...
        "cyp3a4_substrate_carbonmangels__chemberta_kpgt_ept_gated__seed_*/run_*/cyp3a4_substrate_carbonmangels/{split}_predictions.csv"
    ),
    ...
    "layer2_5seed": (
        "results_strict/official_layerwise_selected_5seed_v1/"
        "cyp3a4_substrate_carbonmangels__chemberta_kpgt_ept_gated__layer_2__seed_*/run_*/cyp3a4_substrate_carbonmangels/{split}_predictions.csv"
    ),
}
...
SINGLETONS = {
    "sidecar_v1": (
        "results_strict/descriptor_sidecar_official_v1/cyp3a4_substrate_carbonmangels__chemberta_kpgt_ept_gated/valid_predictions.csv",
        "results_strict/descriptor_sidecar_official_v1/cyp3a4_substrate_carbonmangels__chemberta_kpgt_ept_gated/test_predictions.csv",
        False,
    ),
    "sidecar_v2": (
        "results_strict/descriptor_sidecar_official_v2/cyp3a4_substrate_carbonmangels__chemberta_kpgt_ept_gated/valid_predictions.csv",
        "results_strict/descriptor_sidecar_official_v2/cyp3a4_substrate_carbonmangels__chemberta_kpgt_ept_gated/test_predictions.csv",
        False,
    ),
    "official_sidecar_bagged": (
        "results_strict/official_sidecar_bagged_blend_v1/cyp3a4_substrate_carbonmangels/trainval_predictions.csv",
        "results_strict/official_sidecar_bagged_blend_v1/cyp3a4_substrate_carbonmangels/test_predictions.csv",
        True,
    ),
    "official_sidecar_refine": (
        "results_strict/official_sidecar_bagged_blend_refine_v1/cyp3a4_substrate_carbonmangels/trainval_predictions.csv",
        "results_strict/official_sidecar_bagged_blend_refine_v1/cyp3a4_substrate_carbonmangels/test_predictions.csv",
        True,
    ),
    "xl_v4": (
        "results_strict/paper_main_chemical_prior_xl_v4_all22_32core/cyp3a4_substrate_carbonmangels/trainval_predictions.csv",
        "results_strict/paper_main_chemical_prior_xl_v4_all22_32core/cyp3a4_substrate_carbonmangels/test_predictions.csv",
        True,
    ),
    "multimodal_prior": (
        "results_strict/paper_main_multimodal_prior_taskwise_v1/cyp3a4_substrate_carbonmangels/trainval_predictions.csv",
        "results_strict/paper_main_multimodal_prior_taskwise_v1/cyp3a4_substrate_carbonmangels/test_predictions.csv",
        True,
    ),
    "rank_tabular": (
        "results_strict/rank_uplift_tabular_all22_v1/cyp3a4_substrate_carbonmangels/trainval_predictions.csv",
        "results_strict/rank_uplift_tabular_all22_v1/cyp3a4_substrate_carbonmangels/test_predictions.csv",
        True,
    ),
}
